...
KHook::Virtual postEventHook(&IGameEventSystem::PostEventAbstract,
...
void UserMessageManager::OnAllInitialized() { postEventHook.Add(globals::gameEventSystem); }

void UserMessageManager::OnShutdown() { postEventHook.Remove(globals::gameEventSystem); }
...
KHook::Return<void> UserMessageManager::Hook_PostEvent(IGameEventSystem* pThis,
